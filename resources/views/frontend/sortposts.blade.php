...
<section class="g-color-white g-bg-gray-dark-v1 g-py-50"style="background-image: url({{asset('main-assets/assets/img/bg/pattern3.png')}}); margin-bottom:20px;">
    <div class="container">
      <div class="d-sm-flex text-center">
        <div class="align-self-center">
        <h2 class="h3 g-font-weight-300 w-100 g-mb-10 g-mb-0--md">Posts | {{$category->name}}</h2>
        </div>
...
<div class="container g-pt-10 g-pb-10">
  <div class="row justify-content-between">
    ...
    <div class="g-pr-20--lg posts endless-pagination" data-next-page="{{$posts->nextPageUrl()}}">
      <h4 class="h3 g-font-weight-1000 w-100 g-mb-10 g-mb-35--md">Showing results for category <strong>"{{$category->name}}"</strong></h4>
     <!-- Blog Minimal Blocks -->
         ...
         @endif
           <ul class="list-inline g-brd-y g-brd-gray-light-v3 g-font-size-13 g-py-13 mb-0">
             <li class="list-inline-item g-color-gray-dark-v4 mr-2">
               ...
               @else
               <img class="g-g-width-40 g-height-40 rounded-circle mr-2" src="{{asset('hub-images/users-images'.'/'.$picture)}}" alt="{{$p->a}}">
               @endif
               @if($p->username != null)
               <a class="g-color-primary-dark-v5" href="{{URL::to('user/'.'@'.$p->username)}}">{{$p->author}}</a>
               @else
               <a class="g-color-primary-dark-v5" href="{{URL::to('/about')}}">Incube</a>
               @endif
                 </span>
             </li>
    ...
    margin-left: auto;
    margin-right: auto;
    width: 40%;height:150px; width:300px;" src="{{asset('main-assets/stock/notfound.png')}}"/>
     @endif
     <!-- End Blog Minimal Blocks -->
      </div>
      @if($countposts > 5)
        ...
        {{--  End Write To US Start  --}}
         ...
         <div class="g-mb-10">
            ...
            <ul class="u-list-inline mb-0">
              ...
              <li class="list-inline-item g-mb-10">
              <a class="
              @if(Request::is('posts/category'.'/'.$c->slug))
              ...
              @endif
              " href="{{URL::to('posts/category'.'/'.$c->slug)}}">{{$c->name}}</a>
              </li>
              @endforeach
