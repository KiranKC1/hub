...
<link rel="stylesheet" type="text/css" href="{{asset('admin-assets/tag-plugin/src/bootstrap-tagsinput.css')}}" />
  <section id="posts">  
    <div class="row">
                            ...
                            <div class="table-responsive" id="eventstable">
                                <table class="table mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        <?php
                                        $date_facturation = \Carbon\Carbon::parse($p->event_date);
                                         ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                    <a href="{{route('events.view',$p->id)}}" class="btn btn-sm btn-info"><i class="icon-eye4"></i>View</a>
        ...
        @if(count($pastevents) != null)
        <div class="row">
                <div class="col-xs-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Expired Events</h4>
                            <a class="heading-elements-toggle"><i class="icon-ellipsis font-medium-3"></i></a>
                            <div class="heading-elements">
                                <ul class="list-inline mb-0">
                                    <li><a data-action="collapse"><i class="icon-minus4"></i></a></li>
            ...
            swal({
                ...
                $.post("{{route('events.destroy')}}",{id:id,_token:"{{csrf_token()}}"},function(data){
                  swal({
                    ...
                    window.location.href = "{{URL::to('admin/events')}}";
                  })
                })
              });
        });
