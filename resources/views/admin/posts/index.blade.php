                                ...
                                {{csrf_field()}}
                                    <div class="form-body">
                                        ...
                                        <div class="form-group">
                                                ...
                                                <div class="position-relative has-icon-left">
                                                <input class="form-control border-primary" id="tags" type="text" name="post_tag" value="{{old('tags')}}"  placeholder="Tags for the post" data-role="tagsinput">
                                                <div class="form-control-position">
                                                        <i class="icon-tags"></i>
                                                    </div>
                                                </div>
                                ...
                                <table class="table mb-0">
                                    <thead>
                                        <tr>
                                            <th>#</th>
                                            <th>Title</th>
                                            <th style="padding-left: 0px;padding-right: 0px;">Featured</th>
                                            <th>Actions</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td style="padding-left: 0px;padding-right: 5px;" >
                                                    <a href="{{route('posts.view',$p->id)}}" class="btn btn-sm btn-info"><i class="icon-eye4"></i>View</a>
...
<script>
        ...
        $(document).on('click',"[id*='feature']",function(event){
            ...
            $.ajax({
              type: "POST",
              url: "{{URL::to('admin/featurearticle')}}",
              data: { 
              post_id: id,
              _token:"{{csrf_token()}}"
        },
