        ...
        <div class="row">
                <div class="breadcrumb-wrapper col-xs-12">
                        <ol class="breadcrumb" style="padding-bottom:10px;">
                          ...
                          <li class="breadcrumb-item active"><a href="{{URL::to('admin/users/posts/verify')}}">User Posts</a>
                          </li>
                ...
                <div class="card">
                      <div class="card-body">
                          ...
                          <div class="card-block" style="padding-top:0px;">
                                <form class="form" action="{{route('admin.approve.post')}}" method="POST" enctype="multipart/form-data">
                                    {{csrf_field()}}
                                        <div class="form-body">
                                            ...
                                            <div class="form-group">
                                                    ...
                                                    <img style="padding-bottom: 15px;" src="{{asset('hub-images/user-posts-images'.'/'.$posts->featured_image)}}" id='img-upload'/>
                                                </div>
                                                
            
            
                                        </div>
                                        <input type="hidden" name="unapproved_id" value="{{$posts->id}}">
                                    <input type="hidden" value="{{$posts->featured_image}}" name="image_users_post"/>
                                    ...
                                    <input type="hidden" name="author" value="{{$posts->author}}"/>
                                    <input type="hidden" name="username" value="{{$posts->username}}"/>
                                    </form>
                        </div>
