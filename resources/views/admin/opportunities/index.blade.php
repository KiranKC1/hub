...
<link rel="stylesheet" type="text/css" href="{{asset('admin-assets/tag-plugin/src/bootstrap-tagsinput.css')}}" />
  <section id="posts">  
    <div class="row">
                                ...
                                <div class="row">
                                        <div class="breadcrumb-wrapper col-md-8">
                                                <ol class="breadcrumb" style="padding-bottom: 0px;padding-top: 7px;">
                                                  ...
                                                  <li class="breadcrumb-item ">Opportunities
                                                  </li>
        ...
        @if(count($expiredoppo) != null)
        <div class="row">
                <div class="col-xs-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Expired Opporunities</h4>
                            <a class="heading-elements-toggle"><i class="icon-ellipsis font-medium-3"></i></a>
                            <div class="heading-elements">
                                <ul class="list-inline mb-0">
                                    <li><a data-action="collapse"><i class="icon-minus4"></i></a></li>
                        ...
                        <div class="card-body collapse in">
                            <div class="table-responsive" id="expiredopportunities">
                                <table class="table mb-0">
                                    <thead>
                                        <tr>
                                            <th>#</th>
                                    ...
                                    <tbody>
                                        @foreach($expiredoppo as $index => $p)
                                        <?php
                                        $date_facturation = \Carbon\Carbon::parse($p->date);
                                         ?>
                                         @if($date_facturation <= Carbon\Carbon::today())
                                        <tr>
                                            ...
                                            <td>
                                                    <a href="{{route('opportunities.view',$p->id)}}" class="btn btn-sm btn-info"><i class="icon-eye4"></i>View</a>
                                                    <a href="{{route('opportunities.edit',$p->id)}}" class="btn btn-sm btn-primary"><i class="icon-pencil3"></i>Edit</a>
                                                    <a href="#" id="deleteexpoppo{{$p->id}}" class="btn btn-sm btn-danger"><i class="icon-trash-o"></i>Delete</a>
                                            </td>
                                        </tr>
                                        @endif
                                        @endforeach
            ...
            <div class="text-center">
                {{$expiredoppo->links("pagination::bootstrap-4")}}
            </div>
            @endif
  </section>
